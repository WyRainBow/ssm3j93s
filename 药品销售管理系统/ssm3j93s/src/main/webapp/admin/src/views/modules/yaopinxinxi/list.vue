<template>
  <div class="main-content">
		    ...
		    label="价格">
		     <template slot-scope="scope">
                ...
                <el-button v-if="isAuth('yaopinxinxi','查看') && contents.tableBtnIcon == 0" type="success" size="mini" @click="addOrUpdateHandler(scope.row.id,'info')">{{ contents.tableBtnFont == 1?'详情':'' }}</el-button>
                                                                <el-button v-if="isAuth('yaopinxinxi','入库') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="yaopinrukuCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'入库':'' }}</el-button>
                <el-button v-if="isAuth('yaopinxinxi','入库') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="yaopinrukuCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'入库':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('yaopinxinxi','入库') && contents.tableBtnIcon == 0" type="success" size="mini" @click="yaopinrukuCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'入库':'' }}</el-button>
                                                <el-button v-if="isAuth('yaopinxinxi','出库') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="yaopinchukuCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'出库':'' }}</el-button>
                <el-button v-if="isAuth('yaopinxinxi','出库') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="yaopinchukuCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'出库':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('yaopinxinxi','出库') && contents.tableBtnIcon == 0" type="success" size="mini" @click="yaopinchukuCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'出库':'' }}</el-button>
                ...
                <el-button v-if="isAuth('yaopinxinxi','查看评论') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="primary" icon="el-icon-edit" size="mini" @click="disscussListHandler(scope.row.id)">{{ contents.tableBtnFont == 1?'查看评论':'' }}</el-button>
                <el-button v-if="isAuth('yaopinxinxi','查看评论') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="primary" size="mini" @click="disscussListHandler(scope.row.id)">{{ contents.tableBtnFont == 1?'查看评论':'' }}<i class="el-icon-edit el-icon--right" /></el-button>
                <el-button v-if="isAuth('yaopinxinxi','查看评论') && contents.tableBtnIcon == 0" type="primary" size="mini" @click="disscussListHandler(scope.row.id)">{{ contents.tableBtnFont == 1?'查看评论':'' }}</el-button>
    ...
    <add-or-update v-if="addOrUpdateFlag" :parent="this" ref="addOrUpdate"></add-or-update>
            ...
            <yaopinruku-cross-add-or-update v-if="yaopinrukuCrossAddOrUpdateFlag" :parent="this" ref="yaopinrukuCrossaddOrUpdate"></yaopinruku-cross-add-or-update>
        <yaopinchuku-cross-add-or-update v-if="yaopinchukuCrossAddOrUpdateFlag" :parent="this" ref="yaopinchukuCrossaddOrUpdate"></yaopinchuku-cross-add-or-update>
...
import yaopinrukuCrossAddOrUpdate from "../yaopinruku/add-or-update";
import yaopinchukuCrossAddOrUpdate from "../yaopinchuku/add-or-update";
export default {
  data() {
    return {
                                                                                                                                                                                                                                          searchForm: {
      ...
      addOrUpdateFlag:false,
                  yaopinrukuCrossAddOrUpdateFlag: false,
            yaopinchukuCrossAddOrUpdateFlag: false,
...
//导出excel
  ...
  components: {
    AddOrUpdate,
            yaopinrukuCrossAddOrUpdate,
        yaopinchukuCrossAddOrUpdate,
          },
  methods: {
    contentStyleChange() {
    ...
    contentPageStyleChange(){
      ...
      this.contents.pageEachNum = 10
            ...
            yaopinrukuCrossAddOrUpdateHandler(row,type){
      this.showFlag = false;
      this.addOrUpdateFlag = false;
      this.yaopinrukuCrossAddOrUpdateFlag = true;
      this.$storage.set('crossObj',row);
      this.$storage.set('crossTable','yaopinxinxi');
      this.$nextTick(() => {
        this.$refs.yaopinrukuCrossaddOrUpdate.init(row.id,type);
      });
    },
        yaopinchukuCrossAddOrUpdateHandler(row,type){
      this.showFlag = false;
      this.addOrUpdateFlag = false;
      this.yaopinchukuCrossAddOrUpdateFlag = true;
      this.$storage.set('crossObj',row);
      this.$storage.set('crossTable','yaopinxinxi');
      this.$nextTick(() => {
        this.$refs.yaopinchukuCrossaddOrUpdate.init(row.id,type);
      });
    },
                    init () {
                                                                                                                                                                                                                                                                                                                                          },
