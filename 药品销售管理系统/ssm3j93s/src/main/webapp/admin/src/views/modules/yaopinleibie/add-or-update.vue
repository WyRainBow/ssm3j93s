...
export default {
  data() {
	...
	yaopinleibie : false,
            ...
            ruleForm: {
                          ...
                          rules: {
                  yaopinleibie: [
                            { required: true, message: '药品类别不能为空', trigger: 'blur' },
                                    	                                                              ],
              }
    };
  },
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `yaopinleibie/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yaopinleibieCrossAddOrUpdateFlag = false;
                  this.parent.search();
