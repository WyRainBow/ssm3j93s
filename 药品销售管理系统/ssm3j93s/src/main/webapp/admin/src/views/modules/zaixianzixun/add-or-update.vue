          ...
          <el-form-item class="input" label="标题" prop="biaoti">
              <el-input v-model="ruleForm.biaoti" 
                placeholder="标题" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="咨询内容" prop="zixunneirong">
          <el-input v-model="ruleForm.zixunneirong" 
              placeholder="咨询内容" clearable  :readonly="ro.zixunneirong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="咨询内容" prop="zixunneirong">
              <el-input v-model="ruleForm.zixunneirong" 
                placeholder="咨询内容" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
