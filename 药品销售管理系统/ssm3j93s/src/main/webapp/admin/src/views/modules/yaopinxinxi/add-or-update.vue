          ...
          <el-form-item class="input" label="药品名称" prop="yaopinmingcheng">
              <el-input v-model="ruleForm.yaopinmingcheng" 
                placeholder="药品名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="药品类别" prop="yaopinleibie">
          <el-select v-model="ruleForm.yaopinleibie" placeholder="请选择药品类别">
            <el-option
                v-for="(item,index) in yaopinleibieOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
          ...
          <el-form-item class="input" label="规格" prop="guige">
              <el-input v-model="ruleForm.guige" 
                placeholder="规格" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="厂家" prop="changjia">
          <el-input v-model="ruleForm.changjia" 
              placeholder="厂家" clearable  :readonly="ro.changjia"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="厂家" prop="changjia">
              <el-input v-model="ruleForm.changjia" 
          ...
          <el-form-item class="input" label="价格" prop="price">
              <el-input v-model="ruleForm.price" 
                placeholder="价格" readonly></el-input>
                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="药品详情" prop="yaopinxiangqing">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.yaopinxiangqing" label="药品详情" prop="yaopinxiangqing">
                    <span v-html="ruleForm.yaopinxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                            ...
                                                            this.$http({
              url: `option/yaopinleibie/yaopinleibie`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.yaopinleibieOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
	...
	this.ruleForm.yaopinxiangqing = this.ruleForm.yaopinxiangqing.replace(reg,'../../../ssm3j93s/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
